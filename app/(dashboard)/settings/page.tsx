    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          ...
          These settings control the entire document compliance platform.
        </p>
      </div>
      ...
      <Card className="glass-card border border-border bg-card">
        ...
        <CardContent className="flex flex-col gap-2">
          ...
          {[
            ...
            <div key={stage} className="flex items-center justify-between bg-secondary/30 rounded-lg px-3 py-2">
      ...
      <Card className="glass-card border border-border bg-card">
        ...
        <CardContent className="flex flex-col gap-2">
          ...
          <div className="flex justify-between bg-secondary/30 px-3 py-2 rounded-lg">
          ...
          <div className="flex justify-between bg-secondary/30 px-3 py-2 rounded-lg">
            ...
            <span className="text-xs font-mono">ai-compliance-documents</span>
          </div>
      ...
      <Card className="glass-card border border-border bg-card">
        ...
        <CardContent className="flex flex-col gap-2">
          ...
          {[
            ...
            <div key={item} className="flex items-center justify-between bg-secondary/30 px-3 py-2 rounded-lg">
      ...
      <p className="text-xs text-muted-foreground/60 text-center">
        ...
        Pipeline: <code className="font-mono">pipeline-orchestrator</code>
      </p>
